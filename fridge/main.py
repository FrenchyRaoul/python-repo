...
def readadc(adcnum, clockpin, mosipin, misopin, cspin):
    ...
    return adcout  # change these as desired - they're the pins connected from the
...
print("Relay starting state: {}".format(relayEnable))
...
try:
    while True:
        ...
        if relayEnable == 0:
            ...
            print("The relay has been off for {} seconds.".format(currentOffTimeSeconds))
        elif relayEnable == 1:
            ...
            print("The relay has been on for {} seconds.".format(currentOnTimeSeconds))
